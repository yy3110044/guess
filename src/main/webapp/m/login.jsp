			...
			<div id="vux_view_box_body" class="weui-tab__panel vux-fix-safari-overflow-scrolling">
				<div data-v-73db18bc="" class="login-page router-view">
					...
					<div data-v-0fdb235f="" data-v-73db18bc="" class="base-input">
						<input data-v-0fdb235f="" type="text" id="userName" placeholder="用户名 / 手机号" autocomplete="off" autocorrect="off" autocapitalize="off">
						<label data-v-0fdb235f="" for="帐号" class="input-label">帐号 </label>
						<span data-v-0fdb235f="" class="focus-border"></span>
					</div>
					<div data-v-0fdb235f="" data-v-73db18bc="" class="base-input">
						<input data-v-0fdb235f="" type="password" id="passWord" placeholder="请输入密码" autocomplete="off" autocorrect="off" autocapitalize="off">
					...
					<section data-v-73db18bc="" class="login-setting">
						<label data-v-73db18bc="" class="container" style="visibility:hidden;">
							<span data-v-73db18bc="">记住我</span>
							<input type="checkbox">
							<span class="checkmark"></span>
						</label>
						<a data-v-73db18bc="" href="javascript:;" class="forgot-pwd">忘记密码?</a>
					</section>
					<div data-v-0f69c571="" data-v-73db18bc="" class="base-button">
						<div data-v-0f69c571="" class="button-border">
							<button data-v-0f69c571="" type="button" onclick="login()" class="button-content">登录</button>
						</div>
					</div>
					<div data-v-0f69c571="" data-v-73db18bc="" class="base-button base-button-dark">
						<div data-v-0f69c571="" class="button-border">
							<button data-v-0f69c571="" type="button" onclick="window.location.href='${basePath}m/registry.jsp'" class="button-content">注册</button>
						</div>
					</div>
