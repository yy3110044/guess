...
<title>管理员登录 - <%=com.yy.guess.util.Util.getConfigCom(application).getWebTitle()%></title>
...
<div class="login-wrap" style="height:270px;">
	<table style="width:100%;">
		...
		<tr>
			<td><input type="text" id="userName" value="" class="login_input login_user"/></td>
		</tr>
		<tr>
	    	<td height="35" valign="bottom">密  码：</td>
		</tr>
		<tr>
	    	<td><input type="password" id="passWord" value="" class="login_input login_password"/></td>
		</tr>
		<!-- 
		<tr>
