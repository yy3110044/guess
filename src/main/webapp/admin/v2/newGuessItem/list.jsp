...
<title>项目列表 - <%=com.yy.guess.util.Util.getConfigCom(application).getWebTitle()%></title>
...
<script>
var del = function(itemId, e) {
	if(!confirm('确定删除？')) {
		return;
	}
	loadData({
		url : "administration/v2/itemAdmin/delete",
		data : {
			"itemId" : itemId
		},
...
var query = function(pageSize, pageNo) {
	loadData({
		url : "administration/v2/itemAdmin/list",
		data : {
			"pageSize" : pageSize,
			"pageNo" : pageNo
		},
	...
	<table class="table table-bordered table-striped table-hover">
		<tr>
			<td colspan="99" style="padding:3px;line-height:30px;">
				<a href="admin/v2/newGuessItem/add.jsp" target="_blank">添加项目</a>
			</td>
		</tr>
		<tr align="center">
